        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {otherOfficeBearers.map((member) => (
            ...
            >
              ...
              <div className="pt-6 border-t border-border dark:border-darkBorder mt-6 flex justify-between items-center">
                <Button
                  variant="outline"
                  size="sm"
        ...
        {selectedMember && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-sm">
            <motion.div
              ...
              ref={modalRef}
              className="bg-white dark:bg-darkCard rounded-card shadow-xl max-w-2xl w-full max-h-[85vh] overflow-y-auto border border-border dark:border-darkBorder flex flex-col"
              role="dialog"
              aria-modal="true"
              aria-labelledby="modal-member-name"
            >
              {/* Close Header */}
              <div className="flex justify-between items-center p-4 border-b border-border dark:border-darkBorder select-none">
                <span className="text-2xs font-bold text-crimson uppercase tracking-wider">
                  Member Profile Card
                </span>
                <button
                  onClick={() => setSelectedMember(null)}
                  className="p-1.5 text-textSecondary dark:text-slate-400 hover:text-textPrimary dark:hover:text-white rounded-full hover:bg-surface dark:hover:bg-darkSurface transition-colors focus:outline-none focus:ring-2 focus:ring-crimson"
              ...
              <div className="p-6 md:p-8 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start text-center sm:text-left select-none">
                  <div className="w-24 h-24 rounded-full border-2 border-navy dark:border-crimson overflow-hidden bg-slate-100 dark:bg-darkBg flex-shrink-0 flex items-center justify-center font-display font-extrabold text-navy dark:text-white text-3xl">
                  ...
                  <div className="space-y-1">
                    <span className="px-2.5 py-0.5 bg-navy/10 dark:bg-crimson/10 text-navy dark:text-crimson text-2xs font-semibold rounded-full uppercase tracking-wider">
                      {selectedMember.position}
                    </span>
                    <h3 id="modal-member-name" className="text-xl sm:text-2xl font-display font-bold text-navy dark:text-white">
                      {selectedMember.name}
                    </h3>
                    <p className="text-textSecondary dark:text-slate-400 text-xs">
                      {selectedMember.department} Department <span className="text-slate-300 dark:text-slate-600 mx-1.5">|</span> Semester {selectedMember.semester}
                    </p>
                  </div>
                </div>
                ...
                {/* Bio / Quote Statement */}
                <div className="space-y-2">
                  <h4 className="font-body font-bold text-xs uppercase tracking-wider text-navy dark:text-white select-none">
                    Personal Statement:
                  </h4>
                  <p className="text-textSecondary dark:text-slate-300 text-sm italic font-body leading-relaxed border-l-2 border-crimson pl-4 py-0.5">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="space-y-1.5 text-xs text-textSecondary dark:text-slate-400 list-disc list-inside">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-textSecondary dark:text-slate-300 text-xs sm:text-sm leading-relaxed">
                    {selectedMember.bio}
                  </p>
                </div>

                {/* Contact and Social Connections */}
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-6 border-t border-border dark:border-darkBorder select-none">
                  ...
                  <div className="flex items-center space-x-3">
                    {selectedMember.socials.instagram && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-8 h-8 rounded-full bg-surface dark:bg-darkSurface hover:bg-crimson/10 text-slate-500 dark:text-slate-400 hover:text-crimson flex items-center justify-center transition-colors focus:outline-none"
